        ...
        <div className={`${s.answerWrap} min-w-0 max-w-full flex-1 sm:max-w-[calc(100%_-_3rem)]`}>
          <div className='relative text-sm text-gray-900'>
            <div className='chat-answer-card min-w-0 rounded-2xl border border-[#17342b]/[0.08] bg-white px-3 py-3.5 shadow-[0_10px_30px_rgba(31,54,46,0.055)] sm:ml-2 sm:px-5 sm:py-4'>
              ...
              {(item as any).isError && (
                <div className="mt-4 flex flex-wrap items-center gap-2 rounded-xl border border-red-100 bg-red-50 px-3 py-2 text-xs text-red-700">
                  <span>本轮生成未完成。</span>
                  {onRetry && (
                    <button
                      type="button"
                      className="rounded-full bg-red-600 px-3 py-1 font-semibold text-white transition hover:bg-red-700 active:scale-95"
