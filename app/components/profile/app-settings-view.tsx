...
import { isNetworkStudyApp, readNativeDownloadSettings, type NativeDownloadSettings, type NativeDownloadTask } from '@/lib/native-app'
...
export default function AppSettingsView({ initialTheme }: { initialTheme: string }) {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      globalThis.removeEventListener('network-study-downloads-changed', refresh)
    }
  }, [refresh])
